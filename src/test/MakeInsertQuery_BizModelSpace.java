...
public class MakeInsertQuery_BizModelSpace {

	public static void main(String[] args) {
		try {
			String content = FileUtil.readString("src/test/biz_total.csv");
			...
			for (int i = 0; i < unitRows.length; i++) {
				...
				query.append("insert into bizModelSpace(id, psid, customersegments, customerrelationships, channels, keyactivities, keyresources, keypartners, coststructure, revenuestreams)");
				query.append(" values ('bizModel").append(psId).append("','").append(psId).append("'");
