	...
	<table class="tc" style="width:640px;min-height:200px;margin-left:auto;margin-right:auto;">
		...
		<tr>
			<td colspan="8" style="height:20px;border-bottom:none;padding-bottom:0">
				<div class="tc" style="margin: 0px 270px;background-color: rgb(253, 125, 253);border: black 2px solid;font-size: 11px;"><fmt:message key="pss.valueSpace.PSSValues"/></div>
		...
		<tr>
			<td class="vt edit_action" colspan="1" style="height:100%;padding:0;border-bottom:none">
				...
				<div class="tc" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: yellow;line-height: 12px; height:auto;"><fmt:message key="pss.valueSpace.EcologicalValue"/></div>
				<div>
					<%
			...
			<td class="vt edit_action" colspan="1" style="height:100%;padding:0;border-bottom:none">
				...
				<div class="tc" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: yellow;line-height: 12px; height:auto;"><fmt:message key="pss.valueSpace.EconomicalValue"/></div>
				<div>
					<%
			...
			<td class="vt edit_action" colspan="6" style="height:100%;padding:0;border-bottom:none">
				...
				<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px 200px;background-color: yellow;line-height: 12px;margin-bottom:0; height:auto;"><fmt:message key="pss.valueSpace.ExperienceValue"/></div>
				<div style="float:left;width:50%;height:7px;border-right:black 2px solid"></div>
				<table class="tc" style="width:100%;height:100%">
					...
					<tr>
						<td colspan="2"  style="padding:0;border-bottom:none">
							<div style="float:right;width:50%;border-top:black 2px solid;border-left: black 2px solid;height: 7px;"></div>
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px 40px 0;background-color: rgb(252, 220, 247);line-height: 16px;"><fmt:message key="pss.valueSpace.Extrinsic"/></div>
							<div style="float:left;width:50%;height:7px;border-right:black 2px solid"></div>
						</td>
						<td colspan="4"  style="padding:0;border-bottom:none">
							<div style="float:left;width:50%;border-top:black 2px solid;border-right: black 2px solid;height: 7px;"></div>
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px 120px 0;background-color: rgb(252, 220, 247);line-height: 16px;"><fmt:message key="pss.valueSpace.Intrinsic"/></div>
							<div style="float:left;width:50%;height:7px;border-right:black 2px solid"></div>
						</td>
					</tr>
					<tr>
						<td style="height:100%;padding:0;border-bottom:none">
							<div style="float:right;width:50%;border-top:black 2px solid;border-left: black 2px solid;height: 7px;"></div>
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: rgb(183, 229, 253);line-height:12px;height:24px"><span style="position: relative;top: 7px;"><fmt:message key="pss.valueSpace.Function"/></span></div>
							<div>
								<%
						...
						<td style="height:100%;padding:0;border-bottom:none">
							<div style="float:left;width:50%;border-top:black 2px solid;border-right: black 2px solid;height: 7px;"></div>
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: rgb(183, 229, 253);line-height:12px">
								<div>
									<fmt:message key="pss.valueSpace.Extrinsic"/>
								</div>
								<div>
									<fmt:message key="pss.valueSpace.Social"/>
								</div>
							</div>
							<div>
								<%
						...
						<td style="height:100%;padding:0;border-bottom:none">
							...
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: rgb(183, 229, 253);line-height:12px">
								<div>
									<fmt:message key="pss.valueSpace.Active"/>
								</div>
								<div>
									<fmt:message key="pss.valueSpace.Emotional"/>
								</div>
							</div>
							<div>
								<%
						...
						<td style="height:100%;padding:0;border-bottom:none">
							...
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: rgb(183, 229, 253);line-height:12px">
								<div>
									<fmt:message key="pss.valueSpace.Reactive"/>
								</div>
								<div>
									<fmt:message key="pss.valueSpace.Emotional"/>
								</div>
						...
						<td style="height:100%;padding:0;border-bottom:none">
							...
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: rgb(183, 229, 253);line-height:12px">
								<div>
									<fmt:message key="pss.valueSpace.Intrinsic"/>
								</div>
								<div>
									<fmt:message key="pss.valueSpace.Social"/>
								</div>
						...
						<td style="height:100%;padding:0;border-bottom:none">
							<div style="float:left;width:50%;border-top:black 2px solid;border-right: black 2px solid;height: 7px;"></div>
							<div class="tc cb" style="font-size: 11px;border: black 2px solid;margin: 7px;background-color: rgb(183, 229, 253);line-height:12px;height:24px"><span style="position: relative;top: 7px;"><fmt:message key="pss.valueSpace.Epistemic"/></span></div>
							<div>
								<%
