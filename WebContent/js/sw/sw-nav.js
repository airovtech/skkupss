...
(function($){
	...
	var methods = {
		init : function(options) {
			try{
				...
				smartPop.showInfo(smartPop.ERROR, smartMessage.get('technicalProblemOccured') + '[sw-nav methods init]', null, error);
			}				
		},
		move : function(event) {
			try{
				...
				smartPop.showInfo(smartPop.ERROR, smartMessage.get('technicalProblemOccured') + '[sw-nav methods move]', null, error);
			}				
		}
	};
	...
	smartPop.showInfo(smartPop.ERROR, smartMessage.get('technicalProblemOccured') + '[sw-nav script]', null, error);
}
